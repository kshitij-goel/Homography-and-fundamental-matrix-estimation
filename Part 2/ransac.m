function [ bestFitModel, inind ] = ransac( parameters, matches, fitModelFxn, errorFxn )
...
%   Detailed explanation goes here
    ...
    for i = 1 : parameters.numIterations;
        ...
        inind = find(residualErrors < parameters.inlierDistThreshold);      

        %record the number of inliers
        numInliersEachIteration(i) = length(inind);
